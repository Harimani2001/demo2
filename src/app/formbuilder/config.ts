...
//        roles: 'Access',
          ...
          selectionsMessage: 'Do you want to pre-populate the drop-down into table',
          size: 'Size',
          'size.xs': 'Extra Small',
          'size.sm': 'Small',
          'size.m': 'Default',
          ...
          viewXML: '&lt;/&gt;',
          yes: 'Yes',
          addOptionButtonName:'Bulk Options',
          addOptionButton:'Add Options +',
          addQR:'Include in QR code Generation',
          addTaskCreation:'Task Creation required',
          section:'Section'
        }
      }
    };
