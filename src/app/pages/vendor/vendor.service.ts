...
export class VendorService {
  ...
  save_vendor_validation_url: string =this.helper.common_URL+"vendor/saveVendorValidationDetails";
  ...
  saveVendorValidation(data): any {
    return this.http.post(this.save_vendor_validation_url, data, this.config.getRequestOptionArgs())
      .map((resp) => resp.json())
      .catch(res => {
        return Observable.throw(res.json());
      });
  ...
  loadVendorValidationDetailsBasedOnId(id): any {
    return this.http.post(this.load_vendor_validation_details_based_on_id_url, id, this.config.getRequestOptionArgs())
      .map((resp) => resp.json())
      .catch(res => {
        return Observable.throw(res.json());
      });
  ...
  deleteVendorValidation(model: VendorValidationDTO): any {
    return this.http.post(this.delete_vendor_validation_details_url, model, this.config.getRequestOptionArgs())
      .map((resp) => resp.json())
      .catch(res => {
        return Observable.throw(res.json());
      });
