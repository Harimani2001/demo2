...
video.style.cssText = 'position:absolute;top:300px;left:300px;width:200px;height:200px;';
            video.controls = true;
            video.muted= true;
            ...
            btnStartRecording.onclick = function(event) {
                ...
                if(button.innerHTML === 'Stop Recording') {
                    ...
                    function stopStream() {
                        button.stream.getTracks().forEach(track => track.stop());
                        ...
                        if(button.recordRTC.length) {
                            button.recordRTC[0].stopRecording(function(url) {
                                ...
                                if(!button.recordRTC[1]) {
                                    ...
                                    var file = new File([button.recordRTC[0].getBlob()], fileName, {
                                        type: mimeType
                                        });
                                    fileTOTypeScript=file;
                                    return;
                                }
                            ...
                            button.recordRTC.stopRecording(function(url) {
                                ...
                                var videoTag = document.getElementById("gum")
                                videoTag.style = "display: none"
                            //     var iframeTag= document.getElementById("video_iframe")
                            //     iframeTag.src=document.getElementsByTagName("video")[0].src
                            //     iframeTag.src = url
                            //     iframeTag.style="display: inline-block"
                            //     $('#btn-start-show').click();
                ...
                var commonConfig = {
                    onMediaCaptured: function(stream) {
                        ...
                        if(recordingMedia.value === 'record-audio-plus-video') {
                            ...
                            var videoTag = document.getElementById("gum")
                            videoTag.srcObject = button.stream
                            videoTag.style = "display: inline-block; padding-right: 220px;"
                        }
            ...
            if(typeof MediaRecorder === 'undefined' && (DetectRTC.browser.name === 'Edge')) {
            ...
            function saveToDiskOrOpenNewTab(recordRTC) {
                ...
                // reader.onload = () => {
                //     var iframeTag= document.getElementById("video_iframe")
                //     // var newBlob = Window.dataURLtoBlob(reader.result);
                //     iframeTag.src = URL.createObjectURL(dataURItoBlob(reader.result));
                //     iframeTag.style="display: inline-block"
                //     $('#btn-start-show').click();
                // };
                ...
                if(document.querySelector('#save-to-disk'))
                ...
                if(document.querySelector('#open-new-tab'))
            ...
            function captureAudioPlusScreen(config) {
                if (navigator.getDisplayMedia) {
                    navigator.getDisplayMedia({
                        ...
                        navigator.mediaDevices.getUserMedia({audio:false}).then(function(mic) {
